...
import type { Diagnostic, DiffInfo, ProjectInfo, NuxtDoctorConfig, ScoreResult } from "./types.js";
...
export type { Diagnostic, DiffInfo, ProjectInfo, NuxtDoctorConfig, ScoreResult };
