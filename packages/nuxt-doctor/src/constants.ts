...
export const SFC_FILE_PATTERN = /\.vue$/;
export const SCRIPT_FILE_PATTERN = /\.(tsx|jsx|ts|js)$/;
...
export const SCORE_API_URL = "https://www.nuxt.doctor/api/score";
export const SHARE_BASE_URL = "https://www.nuxt.doctor/share";
